#' @title A Google Doubleclick API client for R
#'
#' @description
#' A package for extracting data from Google Doubleclick API into R.
#'
...
#' }
#'
#' To report a bug please type: \code{utils::bug.report(package = "RDFA")}.
#'
#' @section Useage:
#'
